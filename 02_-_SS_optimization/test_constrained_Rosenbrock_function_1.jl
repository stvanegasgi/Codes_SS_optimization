# Solve Rosenbrock function with with the Subset Simulation (SS) optimization (case 1)
#
#
...
println("\n\n=================================================================")
println("Constrained Rosenbrock 1 function --> SS")
println("X* = $solution\n")
