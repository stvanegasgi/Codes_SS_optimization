...
# bars (case 2) with the Subset Simulation (SS) optimization
#
#
...
include("../../01_-_Optimization_models/truss_72_bars_3D_bound_2.jl"); # model
...
X_OPTIMAL_TRUSS_72_2           = zeros(dimension, executions);
F_OPTIMAL_TRUSS_72_2           = zeros(1, executions);
EVALS_F_OPTIMAL_TRUSS_72_2     = zeros(1, executions);
EVALS_CONST_OPTIMAL_TRUSS_72_2 = zeros(1, executions);
NUM_K_LEVELS_TRUSS_72_2        = zeros(1, executions);

N_test = [100, 200, 300, 400, 500]; # samples to test

for N in N_test

    println("\nTruss 72 bars case 2 N = $(N)")
    println("===============================================")
...
#       save data for the simulation
        X_OPTIMAL_TRUSS_72_2[:, test_i]        = deepcopy(solution);
        F_OPTIMAL_TRUSS_72_2[test_i]           = deepcopy(f_solution);
        EVALS_F_OPTIMAL_TRUSS_72_2[test_i]     = deepcopy(fun_evals);
        EVALS_CONST_OPTIMAL_TRUSS_72_2[test_i] = deepcopy(const_evals);
        NUM_K_LEVELS_TRUSS_72_2[test_i]        = deepcopy(length(f_x_optimal));
end

#   save the variables
    file = "truss_72_bars_case_2_N_"*string(N)*".jld2"
    @save file X_OPTIMAL_TRUSS_72_2 F_OPTIMAL_TRUSS_72_2 EVALS_F_OPTIMAL_TRUSS_72_2 EVALS_CONST_OPTIMAL_TRUSS_72_2 NUM_K_LEVELS_TRUSS_72_2
    println("The simulation truss 72 bars case 2 problem N = $(N) is OK...")
end
