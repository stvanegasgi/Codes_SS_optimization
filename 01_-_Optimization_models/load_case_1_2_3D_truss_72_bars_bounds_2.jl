...
# bars, for the areas bound (case 2) 0.01 [in^2] <= A_i <= 5.0 [in^2]
#
#
# Load conditions:
...
#                           Min      Max
bounds_variables = Float64[ 0.01     5.0;    # A1-A4       [in^2]
                            0.01     5.0;    # A5-A12      [in^2]
                            0.01     5.0;    # A13-A16     [in^2]
                            0.01     5.0;    # A17-A18     [in^2]
                            0.01     5.0;    # A19-A22     [in^2]
                            0.01     5.0;    # A23-A30     [in^2]
                            0.01     5.0;    # A31-A34     [in^2]
                            0.01     5.0;    # A35-A36     [in^2]
                            0.01     5.0;    # A37-A40     [in^2]
                            0.01     5.0;    # A41-A48     [in^2]
                            0.01     5.0;    # A49-A52     [in^2]
                            0.01     5.0;    # A53-A54     [in^2]
                            0.01     5.0;    # A55-A58     [in^2]
                            0.01     5.0;    # A59-A66     [in^2]
                            0.01     5.0;    # A67-A70     [in^2]
                            0.01     5.0];   # A71-A72     [in^2]
...
L2G_truss_72_c2 = elements[:, 1:2];

# difference coordinates end and start node for each element
dif_x = xcor[L2G_truss_72_c2[:, 2], 1] - xcor[L2G_truss_72_c2[:, 1], 1];
dif_y = xcor[L2G_truss_72_c2[:, 2], 2] - xcor[L2G_truss_72_c2[:, 1], 2];
dif_z = xcor[L2G_truss_72_c2[:, 2], 3] - xcor[L2G_truss_72_c2[:, 1], 3];
...
truss_model_72_bars_bounds_2 = structural_model(xcor,
                                                elements,
                                                material_properties,
                                                restricted_dof,
                                                2,
